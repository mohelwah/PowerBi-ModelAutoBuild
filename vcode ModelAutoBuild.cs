...
string myWorkbook = @"C:\Users\root\Desktop\text02.xlsx";
...
string[] tableTypes = {"calculate","FACT","DIM","BRIDGE","SEC","META"};
...
wb.Close();
excelApp.Quit();
System.Runtime.InteropServices.Marshal.ReleaseComObject(excelApp);#r "System.IO"
#r "Microsoft.Office.Interop.Excel"
